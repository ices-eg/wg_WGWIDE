...
head(survey_exp)
summary(survey_exp)
write.csv(survey_exp, paste(outpath,"survey_data_1992-2019_clean.csv",sep = ""),row.names = FALSE)
save(survey_exp, file=paste(outpath,"survey_data_1992-2019_clean.RData",sep = ""))
