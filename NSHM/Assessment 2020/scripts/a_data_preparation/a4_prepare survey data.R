...
load("NSHM/Assessment 2020/results/survey/survey_hh_1991-2019.RData")
load("NSHM/Assessment 2020/results/survey/survey_hl_1991-2019.RData")
...
head(survey_exp)
summary(survey_exp)
write.csv(survey_exp, paste(outpath,"survey_data_1992-2018_clean.csv",sep = ""),row.names = FALSE)
save(survey_exp, file=paste(outpath,"survey_data_1992-2018_clean.RData",sep = ""))
