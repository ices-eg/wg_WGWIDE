...
# Load data
load("NSHM/Assessment 2021/results/survey/survey_data_1992-2020_clean.RData")
...
# 1. Length frequency distribution NS-IBTS ----
...
png(filename=paste0(figpath,"IBTS_length_relat_freq.png"), heigh=2000, width=3500, units="px", pointsize=9, res=450)
...
png(filename=paste0(figpath,"IBTS_length_abs_freq.png"), heigh=2000, width=3500, units="px", pointsize=9, res=450)
...
## Compare with CPUE values from last year
meanCPUE_last <- read.csv("NSHM/Assessment 2020/results/survey/meanCPUE_surveys.csv", stringsAsFactors = FALSE)

png(filename=paste(figpath,"Adult_Average_CPUE_by_haul_compare_last_year.png",sep=""), heigh=2000, width=3500, units="px", pointsize=9, res=450)
plot(meanCPUE_last$Year,meanCPUE_last$FR.CGFS, type="b", col="blue", ylim=c(0,max(meanCPUE)), 
     xlim=c(min(meanCPUE$Year), max(meanCPUE$Year)), pch=19, ylab="Mean CPUE", xlab="Year", main="Exploitable stock")
lines(meanCPUE_last$Year,meanCPUE_last$NS.IBTS, type="b", col="black",pch=19)
lines(meanCPUE$Year, meanCPUE$FR.CGFS, type="b", col="grey40",pch=19)
lines(meanCPUE$Year, meanCPUE$NS.IBTS, type="b", col="red",pch=19)
legend("topright",legend=c("FR-CGFS WGWIDE 2020", "NS-IBTS WGWIDE2020", "FR-CGFS WGWIDE 2021", "NS-IBTS WGWIDE2021"),
       lty=1,pch=19,col=c("blue","black","grey40","red"),bty="n")
dev.off()
