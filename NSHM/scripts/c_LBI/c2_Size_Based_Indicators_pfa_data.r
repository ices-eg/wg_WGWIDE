...
dataPath="C:/Users/berge057/OneDrive - WageningenUR/projects/WG/2019_WGWIDE/2019 assessment/NSHM/data/commercial_data/data_xa_analysis/length_frequency_data/"
outpath="C:/Users/berge057/OneDrive - WageningenUR/projects/WG/2019_WGWIDE/2019 assessment/NSHM/MSY_proxy/Size_Based_Methods/output_PFA/"
...
for (i in years)
{
  ...
  png(filename=paste(outpath,title_name,'_',year,".png",sep=""),height=1500, width=2000, units = "px", pointsize = 7, bg = "white", res = 450, family = "", restoreConsole = TRUE)
  ...
  write.csv(result,paste(outpath,title_name,"_size_Based_Indicators_&_Reference_Points_",year,".csv",sep=""),row.names=F)
  
  ### PDF
  pdf(file = paste(outpath,title_name,"_size_Based_Indicators_&_Reference_Points_",year,".pdf", sep=""))
  ...
  png(filename=paste(outpath,title_name,"_size_Based_Indicators_",year,".png",sep=""),width = 1500, height = 1200, units = "px", pointsize = 4,bg = "white", res = 450)
  ...
  png(filename=paste(outpath,title_name,"_Lmean_Lfm_",year,".png",sep=""),width = 1500, height = 1200, units = "px", pointsize = 5,bg = "white", res = 450)
  ...
  png(filename=paste(outpath,title_name,"_Lmean_Lfm_xa_advice_sheet_",year,".png",sep=""),width = 1500, height = 1200, units = "px", pointsize = 5,bg = "white", res = 450)
